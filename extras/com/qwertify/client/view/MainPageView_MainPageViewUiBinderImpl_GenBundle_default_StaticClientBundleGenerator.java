...
public class MainPageView_MainPageViewUiBinderImpl_GenBundle_default_StaticClientBundleGenerator implements com.qwertify.client.view.MainPageView_MainPageViewUiBinderImpl_GenBundle {
  ...
  private void _init0() {
    ...
    public String getText() {
      return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".Q2DH{text-align:" + ("right")  + ";width:" + ("900px")  + ";margin:" + ("0"+ " " +"auto")  + ";}.Q2IH{text-align:" + ("center")  + ";}.Q2FH{height:" + ("50px")  + ";background-color:" + ("#405774")  + ";padding-top:" + ("10px")  + ";}.Q2GH:hover{opacity:" + ("0.7")  + ";}.Q2HH{height:" + ("30px")  + ";line-height:" + ("30px")  + ";background-color:") + (("#edeff4")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"#d8dfea")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#d8dfea")  + ";margin-bottom:" + ("10px")  + ";padding-top:" + ("3px")  + ";text-align:" + ("right")  + ";display:" + ("none")  + ";}.Q2HH ul{list-style:" + ("none")  + ";display:" + ("inline")  + ";}.Q2HH li{float:" + ("right")  + ";margin-right:" + ("6px") ) + (";margin-left:" + ("6px")  + ";font-weight:" + ("bold")  + ";}.Q2EH a{padding-right:" + ("10px")  + ";padding-left:" + ("10px")  + ";line-height:" + ("10px")  + ";}.Q2EH{background-color:" + ("white")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#d8dfea")  + ";border-bottom:" + ("0")  + ";padding:" + ("5px")  + ";padding-right:" + ("8px")  + ";padding-left:") + (("8px")  + ";padding-bottom:" + ("8px")  + ";color:" + ("#000")  + ";}.Q2EH:hover{text-decoration:" + ("none")  + ";}")) : ((".Q2DH{text-align:" + ("left")  + ";width:" + ("900px")  + ";margin:" + ("0"+ " " +"auto")  + ";}.Q2IH{text-align:" + ("center")  + ";}.Q2FH{height:" + ("50px")  + ";background-color:" + ("#405774")  + ";padding-top:" + ("10px")  + ";}.Q2GH:hover{opacity:" + ("0.7")  + ";}.Q2HH{height:" + ("30px")  + ";line-height:" + ("30px")  + ";background-color:") + (("#edeff4")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"#d8dfea")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#d8dfea")  + ";margin-bottom:" + ("10px")  + ";padding-top:" + ("3px")  + ";text-align:" + ("left")  + ";display:" + ("none")  + ";}.Q2HH ul{list-style:" + ("none")  + ";display:" + ("inline")  + ";}.Q2HH li{float:" + ("left")  + ";margin-left:" + ("6px") ) + (";margin-right:" + ("6px")  + ";font-weight:" + ("bold")  + ";}.Q2EH a{padding-left:" + ("10px")  + ";padding-right:" + ("10px")  + ";line-height:" + ("10px")  + ";}.Q2EH{background-color:" + ("white")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#d8dfea")  + ";border-bottom:" + ("0")  + ";padding:" + ("5px")  + ";padding-left:" + ("8px")  + ";padding-right:") + (("8px")  + ";padding-bottom:" + ("8px")  + ";color:" + ("#000")  + ";}.Q2EH:hover{text-decoration:" + ("none")  + ";}"));
    }
