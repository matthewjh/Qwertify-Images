...
public class Resources_default_InlineClientBundleGenerator implements com.qwertify.client.ui.resources.Resources {
  ...
  private void _init0() {
    ...
    public String getText() {
      return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".Q2IF{height:" + ((Resources_default_InlineClientBundleGenerator.this.crossIcon()).getHeight() + "px")  + ";width:" + ((Resources_default_InlineClientBundleGenerator.this.crossIcon()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Resources_default_InlineClientBundleGenerator.this.crossIcon()).getURL() + "\") -" + (Resources_default_InlineClientBundleGenerator.this.crossIcon()).getLeft() + "px -" + (Resources_default_InlineClientBundleGenerator.this.crossIcon()).getTop() + "px  no-repeat")  + ";}")) : ((".Q2IF{height:" + ((Resources_default_InlineClientBundleGenerator.this.crossIcon()).getHeight() + "px")  + ";width:" + ((Resources_default_InlineClientBundleGenerator.this.crossIcon()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Resources_default_InlineClientBundleGenerator.this.crossIcon()).getURL() + "\") -" + (Resources_default_InlineClientBundleGenerator.this.crossIcon()).getLeft() + "px -" + (Resources_default_InlineClientBundleGenerator.this.crossIcon()).getTop() + "px  no-repeat")  + ";}"));
    }
